...
pub struct TokenLevelMetadata {
    ...
    pub ball_canister: Option<Principal>,
}
...
pub type BallTxReceipt = Result<Nat, BallTxError>;
...
pub type AdminResponse = Result<bool, ApiError>;
